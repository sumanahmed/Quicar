                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="tax_expired_date" name="tax_expired_date" value="{{ date('Y-m-d', strtotime($car->tax_expired_date)) }}" class="form-control datePicker" required/>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="fitness_expired_date" name="fitness_expired_date" value="{{ date('Y-m-d', strtotime($car->fitness_expired_date)) }}" class="form-control datePicker" required/>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="registration_expired_date" name="registration_expired_date" value="{{ date('Y-m-d', strtotime($car->registration_expired_date)) }}" class="form-control datePicker" required/>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="insurance_expired_date" name="insurance_expired_date" value="{{ date('Y-m-d', strtotime($car->insurance_expired_date)) }}" class="form-control datePicker" required/>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="status_message" id="status_message" class="form-control" value="{{ $car->status_message }}" required/>
