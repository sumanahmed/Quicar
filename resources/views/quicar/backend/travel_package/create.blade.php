        ...
        <div class="container-fluid pd-x-0">
            <div class="row row-xs">
                <div class="col-sm-12 col-lg-12">
                    <form action="{{ route('backend.travel.package.store') }}" method="post" enctype="multipart/form-data" novalidate>
                        @csrf
                        <div class="card">
                            <div class="card-header">
                                <h4 class="mt-2 tx-spacing--1 float-left">Update Travel Package</h4>
                            </div>
                            <div class="card-body">                                
                                <div class="row">
                                    <div class="col-4">
                                    ...
                                    <div class="col-3">                                        
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="starting_location" name="starting_location" class="form-control" value="{{ old('starting_location') }}" placeholder="Starting Location" required>
                                        </div>
                                    </div>
                                    <div class="col-3">                                        
                                        <div class="form-group">
                                    ...
                                    <div class="col-3">                                        
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="added_person" name="added_person" class="form-control" value="{{ old('added_person') }}" placeholder="Added Person" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                                        </div>
                                    </div>
                                    <div class="col-3">                                        
                                        <div class="form-group">
                                    ...
                                    <div class="col-2">                                        
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="referrel_code" name="referrel_code" class="form-control" value="{{ old('referrel_code') }}" placeholder="Referrel Code" required>
                                    ...
                                    <div class="col-4">                                        
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="travel_starting_date" name="travel_starting_date" class="form-control datePicker" value="{{ old('travel_starting_date') }}" placeholder="Referrel Code" required>
                                    ...
                                    <div class="col-4">                                        
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="status_message" name="status_message" class="form-control" value="{{ old('status_message') }}" placeholder="Status Message" required>
                                    ...
                                    <div class="col-4">                                        
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="travel_package_rating" name="travel_package_rating" class="form-control" value="{{ old('travel_package_rating') }}" placeholder="Travel Package Rating" required>
