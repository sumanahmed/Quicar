                                    ...
                                    @foreach($years as $year)
                                        <tr class="Year-{{ $year->id }}">
                                            ...
                                            <td style="vertical-align: middle;text-align: center;">
                                                <a href="#" class="btn btn-raised btn-warning" data-toggle="modal" id="editYear" data-target="#editYearModal" data-id="{{ $year->id }}" data-name="{{ $year->value }}" title="Edit"><i class="fas fa-edit"></i></a>
