                ...
                <div class="col-sm-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="mt-2 tx-spacing--1 float-left">All Cancel Rides</h4>
                        </div>
                        <div class="card-body">
                            <table class="table table-bordered" id="cancelRideTable">
...
<script src="{{ asset('quicar/backend/js/ride.js')}}"></script>
    <script>
        ...
        $("#cancel_ride").addClass('active');
        $('#cancelRideTable').DataTable({
            responsive: true,
            language: {
