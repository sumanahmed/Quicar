...
//create offer
$("#createPropertyType").click(function (e) {
    e.preventDefault();
    var name = $("#name").val();
                ...
                $("#allPropertyType").append('' +
                    '<tr class="property_type-'+ response.data.id +'">\n' +
                        ...
                        '<td style="vertical-align: middle;text-align: center;">\n' +                        
                            '<button class="btn btn-warning" data-toggle="modal" id="editPropertyType" data-target="#editPropertyTypeModal" data-id="'+ response.data.id +'" data-name="'+ response.data.name +'" data-status="'+ response.data.status +'" title="Edit"><i class="fas fa-edit"></i></button>\n' +
                            '<button class="btn btn-danger" data-toggle="modal" id="deletePropertyType" data-target="#deletePropertyTypeModal" data-id="'+ response.data.id +'" title="Delete"><i class="fas fa-trash"></i></button>\n' +
                        '</td>\n' +
                    '</tr>'+
                '');
                $("#name").val('');
