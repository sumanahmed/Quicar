...
//create offer
$("#createHotelAmenity").click(function (e) {
    e.preventDefault();
    var name = $("#name").val();
                ...
                $("#allHotelAmenity").append('' +
                    '<tr class="hotel_amenity-'+ response.data.id +'">\n' +
                        ...
                        '<td style="vertical-align: middle;text-align: center;">\n' +                        
                            '<button class="btn btn-warning" data-toggle="modal" id="editHotelAmenity" data-target="#editHotelAmenityModal" data-id="'+ response.data.id +'" data-name="'+ response.data.name +'" data-status="'+ response.data.status +'" title="Edit"><i class="fas fa-edit"></i></button>\n' +
                            '<button class="btn btn-danger" data-toggle="modal" id="deleteHotelAmenity" data-target="#deleteHotelAmenityModal" data-id="'+ response.data.id +'" title="Delete"><i class="fas fa-trash"></i></button>\n' +
                        '</td>\n' +
                    '</tr>'+
                '');
                $("#name").val('');
...
$("#updateHotelAmenity").click(function (e) {
    e.preventDefault();
    var id      = $("#edit_id").val();
