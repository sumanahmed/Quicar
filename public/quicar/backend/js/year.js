                ...
                $("#allYear").append('' +
                    '<tr class="Year-'+ response.data.id +'">\n' +
                        ...
                        '<td style="vertical-align: middle;text-align: center;">\n' +                        
                            '<button class="btn btn-warning" data-toggle="modal" id="editYear" data-target="#editYearModal" data-id="'+ response.data.id +'" data-name="'+ response.data.value +'" data-car_type_id="'+ response.data.car_type_id +'" data-car_model_id="'+ response.data.car_model_id +'" title="Edit"><i class="fas fa-edit"></i></button>\n' +
