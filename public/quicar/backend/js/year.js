                ...
                $("#allYear").append('' +
                    '<tr class="year-'+ response.data.id +'">\n' +
                        ...
                        '<td style="vertical-align: middle;text-align: center;">\n' +                        
                            '<button class="btn btn-warning" data-toggle="modal" id="editYear" data-target="#editYearModal" data-id="'+ response.data.id +'" data-name="'+ response.data.name +'" title="Edit"><i class="fas fa-edit"></i></button>\n' +
