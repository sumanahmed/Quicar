                ...
                $("#allSpot").append('' +
                    '<tr class="spot-'+ response.data.id +'">\n' +
                        ...
                        '<td style="vertical-align: middle;text-align: center;">\n' +                        
                            '<button class="btn btn-warning" data-toggle="modal" id="editSpot" data-target="#editSpotModal" data-id="'+ response.data.id +'" data-name="'+ response.data.value +'" data-bn_name="'+ response.data.bn_name +'" data-district_id="'+ response.data.district_id +'" data-address="'+ response.data.address +'" data-image="'+ response.data.image +'" title="Edit"><i class="fas fa-edit"></i></button>\n' +
