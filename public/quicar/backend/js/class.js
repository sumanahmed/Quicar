                ...
                $("#allClass").append('' +
                    '<tr class="Class-'+ response.data.id +'">\n' +
                        ...
                        '<td style="vertical-align: middle;text-align: center;">\n' +                        
                            '<button class="btn btn-warning" data-toggle="modal" id="editClass" data-target="#editClassModal" data-id="'+ response.data.id +'" data-name="'+ response.data.value +'" title="Edit"><i class="fas fa-edit"></i></button>\n' +
